 ...
 */
final class Version20240125182050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD sender_id INT NOT NULL, ADD receiver_id INT DEFAULT NULL');
